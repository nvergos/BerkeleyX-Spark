# Databricks notebook source exported at Wed, 3 Aug 2016 22:30:48 UTC
# MAGIC %md
...
# Documentation: "Merge the values for each key using an associative reduce function."
# More direct: from operator import add, use "add" as argument of reduceByKey()
...
def removePunctuation(text):
    ...
    """
    return re.sub('[^a-z| |0-9]', '', text.lower().strip())
...
# TODO: Replace <FILL IN> with appropriate code
# key = lambda (word, count): -count -- for descending order
